...
<div class="page-wrap">
	...
	<div class="LAKERTIME"></div>
	<div class="navbar navbar-default p-navbar" role="navigation"<?php if ( strcmp($this->data['title'], "RobloxLandingPage") == 0 ) { ?> style="margin-bottom:0px;" <?php } ?>>
		<div class="container">
	...
	<?php #Wiki Icon and link to homepage ?>
				<li>
					<a style="padding-top:0px;" class="main-icon-link" accesskey="z" title="Visit the main page [z]" href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href']) ?>"><img src="<?php $this->text('logopath')?>" class="main-icon-image"></a>
				</li>
		...
		<?php if ($this->data['view_urls'] || $this->data['action_urls'] || count($this->data['namespace_urls']) > 0 || $this->getToolbox()) { ?>
			...
			?>				</a>	
				...
				<?php } ?>
						<li class="divider"></li>
						<li><a href="/index.php?title=Special:RecentChanges" accesskey="r" title="A list of recent changes in the wiki [r]">Recent Changes</a></li>
					</ul>	
				</li> <?php } ?>
		...
		?>
				<?php if($manualLink) {?><li><a href="<?php echo $manualLink;?>">Manual</a></li><?php } ?>
				<?php if($apiLink) {?><li><a href="<?php echo $apiLink;?>">API</a></li><?php } ?>
				<?php if($tutorialsLink) {?><li><a href="<?php echo $tutorialsLink;?>">Tutorials</a></li><?php } ?>
			</ul>
		...
		<?php
		      ...
		      if ($userInfo) { ?>
				<li>
					<a href="<?php echo $userInfo['links'][0]['href']; ?>" accesskey="." title="Your user page [.]"><span class="user-name-box"><?php echo $userInfo['links'][0]['text'];?></span></a>
				</li>
		<?php }?>
				<li class="dropdown" id="p-navigation">
				...
				$accountList;
				if ($userInfo) {
					$accountList = array_slice($personalTools, 1);
				} else {
					$accountList = $personalTools;
				}
				...
				<li>
					...
					<form class="search-bar-box" id="searchform" action="<?php $this->text('wgScript');?>">
					<div class="input-group input-group-sm">
						...
						<button id="searchButton" class="btn btn-default" type="submit" name="button">Search</button></span>
					</div>
					</form>
				</li>
			</ul>
...
<?php echo "LAKERSTART"; ?>
<?php echo var_dump($personalTools); ?>
<?php echo $personalTools['userpage']; ?>
<?php echo "LAKEREND"; ?>
<?php 
